...
FAutoConsoleCommandWithWorldAndArgs ConnectToLocatorCommand = FAutoConsoleCommandWithWorldAndArgs(
	TEXT("ConnectToLocator"), TEXT("Usage: ConnectToLocator <login> <playerToken>"), FConsoleCommandWithWorldAndArgsDelegate::CreateStatic(&ConsoleCommand_ConnectToLocator));
} // namespace SpatialGDKConsoleCommands
