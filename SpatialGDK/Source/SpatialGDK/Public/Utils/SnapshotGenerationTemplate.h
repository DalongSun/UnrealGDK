...
public:
	 ...
	 */
	virtual bool WriteToSnapshotOutput(Worker_SnapshotOutputStream* OutputStream, Worker_EntityId& NextEntityId) PURE_VIRTUAL(USnapshotGenerationTemplate::WriteToSnapshotOutput, return false;);
};
