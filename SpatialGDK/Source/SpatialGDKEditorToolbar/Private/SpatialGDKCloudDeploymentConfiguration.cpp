	...
	auto AddRequiredFieldAsterisk = [](TSharedRef<SWidget> TextBlock) {
		return SNew(SHorizontalBox) + SHorizontalBox::Slot().AutoWidth().HAlign(HAlign_Left)[TextBlock]
			   + SHorizontalBox::Slot()
					 ...
					 .HAlign(HAlign_Left)
					 .Padding(2.0f, 0.0f)
						 [SNew(STextBlock).Text(LOCTEXT("RequiredFieldAsterisk", "*")).ToolTipText(LOCTEXT("RequiredField_Tooltip", "Required field")).ColorAndOpacity(FLinearColor(1.0f, 0.0f, 0.0f))];
	};
								 ...
								 [SNew(SVerticalBox)
								  + SVerticalBox::Slot().AutoHeight().Padding(
									  1.0f)[SNew(SVerticalBox)
											...
											+ SVerticalBox::Slot().AutoHeight().Padding(2.0f)
												  [SNew(SHorizontalBox)
												   + SHorizontalBox::Slot().FillWidth(1.0f)[AddRequiredFieldAsterisk(
													   SNew(STextBlock).Text(LOCTEXT("AssemblyName_Label", "Assembly Name")).ToolTipText(LOCTEXT("AssemblyName_Tooltip", "The name of the assembly.")))]
												   + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(SEditableTextBox)
											...
											+ SVerticalBox::Slot().AutoHeight().Padding(
												2.0f)[SNew(SHorizontalBox)
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(STextBlock)
																								   .Text(LOCTEXT("UseGDKPinnedRuntime_Label", "Use GDK Pinned Version For Cloud"))
																								   .ToolTipText(LOCTEXT("UseGDKPinnedRuntime_Tooltip",
																														"Whether to use the SpatialOS Runtime version associated to the current GDK "
																														"version for cloud deployments"))]
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(SCheckBox)
											...
											+ SVerticalBox::Slot().AutoHeight().Padding(
												2.0f)[SNew(SHorizontalBox)
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[AddRequiredFieldAsterisk(SNew(STextBlock)
													  ...
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(SFilePathPicker)
												...
												2.0f)[SNew(SHorizontalBox)
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(STextBlock)
																								   ...
																								   .ToolTipText(LOCTEXT("AutoGenerateCloudLaunchConfig_Tooltip",
																														"Whether to automatically generate the launch configuration from the current "
																														"map when a cloud deployment is "
																														"started."))]
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[SNew(SCheckBox)
											...
											+ SVerticalBox::Slot().AutoHeight().Padding(
												2.0f)[SNew(SHorizontalBox) + SHorizontalBox::Slot().FillWidth(1.0f)
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(SButton)
											...
											+ SVerticalBox::Slot().AutoHeight().Padding(
												2.0f)[SNew(SHorizontalBox).Visibility(this, &SSpatialGDKCloudDeploymentConfiguration::GetRegionPickerVisibility)
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[SNew(STextBlock)
													  ...
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[SNew(SComboButton)
																	...
																	.ButtonContent()[SNew(STextBlock).Text_UObject(SpatialGDKSettings, &USpatialGDKEditorSettings::GetPrimaryRegionCodeText)]]]
												...
												2.0f)[SNew(SHorizontalBox)
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(STextBlock)
																								   ...
																								   .ToolTipText(LOCTEXT("PrimaryDeploymentCluster_Tooltip",
																														"The name of the cluster to deploy to. Region code will be ignored if this is "
																														"specified."))]
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[SNew(SEditableTextBox)
																	.Text(FText::FromString(SpatialGDKSettings->GetMainDeploymentCluster()))
																	.ToolTipText(LOCTEXT("PrimaryDeploymentCluster_Tooltip",
																						 "The name of the cluster to deploy to. Region code will be ignored if this is specified."))
											...
											// Separator
											+ SVerticalBox::Slot().AutoHeight().Padding(2.0f).VAlign(VAlign_Center)[SNew(SSeparator)]
											// Explanation text
											+ SVerticalBox::Slot()
												  .AutoHeight()
												  .Padding(2.0f)
												  .VAlign(VAlign_Center)
												  .HAlign(HAlign_Center)[SNew(STextBlock).Text(LOCTEXT("SimulatedPlayers_Label", "Simulated Players"))]
											// Toggle Simulated Players
											+ SVerticalBox::Slot().AutoHeight().Padding(
												2.0f)[SNew(SHorizontalBox)
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(STextBlock).Text(LOCTEXT("EnableSimulatedPlayers_Label", "Add simulated players"))]
													  + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(SCheckBox)
												...
												2.0f)[SNew(SHorizontalBox).Visibility(this, &SSpatialGDKCloudDeploymentConfiguration::GetRegionPickerVisibility)
													  ...
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[SNew(SComboButton)
																	...
																	.ButtonContent()[SNew(STextBlock).Text_UObject(SpatialGDKSettings, &USpatialGDKEditorSettings::GetSimulatedPlayerRegionCode)]]]
												...
												2.0f)[SNew(SHorizontalBox)
													  ...
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[SNew(SEditableTextBox)
																	...
																	.ToolTipText(
																		LOCTEXT("SimPlayerCluster_Tooltip", "The name of the cluster to deploy to. Region code will be ignored if this is specified."))
											...
											+ SVerticalBox::Slot()
												  ...
												  .Padding(2.0f)
												  .VAlign(VAlign_Center)
												  .HAlign(HAlign_Center)[SNew(STextBlock).Text(LOCTEXT("AssemblyConfiguration_Label", "Assembly Configuration"))]
												...
												2.0f)[SNew(SHorizontalBox)
													  ...
													  + SHorizontalBox::Slot().FillWidth(
														  1.0f)[SNew(SComboButton)
																	...
																	.ContentPadding(FMargin(2.0f, 2.0f))
																	.ButtonContent()[SNew(STextBlock).Text_UObject(SpatialGDKSettings, &USpatialGDKEditorSettings::GetAssemblyBuildConfiguration)]
																	.IsEnabled_UObject(SpatialGDKSettings, &USpatialGDKEditorSettings::ShouldBuildAndUploadAssembly)]]
...
FReply SSpatialGDKCloudDeploymentConfiguration::OnStopClicked()
{
	if (TSharedPtr<FSpatialGDKEditor> SpatialGDKEditorSharedPtr = SpatialGDKEditorPtr.Pin())
	{
		...
		SpatialGDKEditorSharedPtr->StopCloudDeployment(FSimpleDelegate::CreateLambda([]() {
														   if (FSpatialGDKEditorToolbarModule* ToolbarPtr = FModuleManager::GetModulePtr<FSpatialGDKEditorToolbarModule>("SpatialGDKEditorToolbar"))
														   {
...
TSharedRef<SWidget> SSpatialGDKCloudDeploymentConfiguration::OnGetBuildConfiguration()
{
	...
	MenuBuilder.AddMenuEntry(FText::FromString(DebugConfiguration),
							 TAttribute<FText>(),
							 FSlateIcon(),
	...
	MenuBuilder.AddMenuEntry(FText::FromString(DebugGameConfiguration),
							 TAttribute<FText>(),
							 FSlateIcon(),
	...
	MenuBuilder.AddMenuEntry(FText::FromString(DevelopmentConfiguration),
							 TAttribute<FText>(),
							 FSlateIcon(),
	...
	MenuBuilder.AddMenuEntry(FText::FromString(TestConfiguration),
							 TAttribute<FText>(),
							 FSlateIcon(),
	...
	MenuBuilder.AddMenuEntry(FText::FromString(ShippingConfiguration),
							 TAttribute<FText>(),
							 FSlateIcon(),
