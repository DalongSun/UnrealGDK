	...
	CloudConnectionCategory.AddCustomRow(LOCTEXT("ProjectName_Filter", "Project Name"))
		.NameContent()[SNew(SHorizontalBox)
					   + SHorizontalBox::Slot().FillWidth(
						   1.0f)[SNew(STextBlock).Text(LOCTEXT("ProjectName_Label", "Project Name")).ToolTipText(LOCTEXT("ProjectName_Tooltip", "The name of the SpatialOS project."))]]
		.ValueContent()
		...
		.MinDesiredWidth(
			550)[SNew(SHorizontalBox)
				 + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(SButton)
															  ...
															  .Content()[SNew(STextBlock).Text(LOCTEXT("PushCommandLineAndroid_Label", "Push SpatialOS settings to Android device"))]]
				 + SHorizontalBox::Slot().FillWidth(1.0f)[SNew(SButton)
															  .VAlign(VAlign_Center)
															  .OnClicked_Static(FSpatialGDKEditorCommandLineArgsManager::RemoveCommandLineFromAndroidDevice)
															  .Content()[SNew(STextBlock).Text(LOCTEXT("RemoveCommandLineAndroid_Label", "Remove SpatialOS settings from Android device"))]]];

	MobileCategory.AddCustomRow(LOCTEXT("PushCommandLineIOS_Filter", "Push SpatialOS settings to iOS device"))
		.ValueContent()
		.VAlign(VAlign_Center)
		.MinDesiredWidth(275)[SNew(SButton)
								  .VAlign(VAlign_Center)
